...
import { specialCards } from "../../constants/specialCards";
...
function SpecialCards() {
  ...
  return (
    <div className="gap-0 p-0 border-0 section-body mobile:flex-wrap">
      {specialCards.map((card) => (
        <div key={card.name} className="w-full parallax-effect detail-card">
          <div className="w-[266px] card-container">
            <svg
              version="1.1"
            ...
            <div className="w-full text-black card-body">
              <Controller
                control={control}
